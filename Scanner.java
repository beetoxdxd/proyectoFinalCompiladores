...
public class Scanner {
    ...
    public List<Token> scan() throws Exception {
            ...
            switch (estado){
                ...
                case 16:
                    if(Character.isDigit(c)){
                        ...
                        lexema = "";
                        estado = 0;
                        Interprete.error(1, "Se esperaba un digito después del punto.");
                    }
                    break;
                ...
                case 18:
                    if(Character.isDigit(c)){
                        ...
                        lexema = "";
                        estado = 0;
                        Interprete.error(1, "Número introducido no válido.");
                    }
                    break;
                ...
                case 19:
                    if(Character.isDigit(c)){
                        ...
                        lexema = "";
                        estado = 0;
                        Interprete.error(1, "Se esperaba un digito después del signo.");
                    }
                    break;
        ...
        if(espacio == 1 && bandera == 0){
            Interprete.error(linea-1, "Se ha detectado un salto de línea sin haber completado la cadena, cuando no debería de haber.");
        }
